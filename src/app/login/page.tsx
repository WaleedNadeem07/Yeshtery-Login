      ...
      {/* Full-Screen Glass Container */}
        ...
        <div className="flex flex-col justify-center items-center w-full md:w-1/2 px-6 md:px-12">
            <div className="w-full max-w-sm mx-auto text-center">
                ...
                {/* Email Input */}
                <div className="flex items-center gap-3 bg-white/40 border border-white rounded-md px-4 py-3 mb-4 w-full">
                ...
                {/* Password Input */}
                <div className="flex items-center gap-3 bg-white/40 border border-white rounded-md px-4 py-3 mb-6 w-full">
                    <svg
                ...
                {/* Login Button */}
                <button className="w-full py-3.5 bg-[#9414FF] text-white rounded-md text-lg font-medium hover:bg-purple-700 transition">
                    Login
                </button>
  ...
  >
    <div className="relative w-full h-full">
      ...
      <Image
        ...
        alt="Spiral Coil"
        fill
        className="absolute inset-0 object-contain scale-570"
      />
    </div>
  </div>

  {/* Meetus AR Logo (separate, not tilted) */}
  <div
    className="absolute"
    style={{
      width: "413px",
